...
| `db/create-photos-bucket.mjs` | Creates the public `photos` Supabase Storage bucket (5 MB, images) for user-uploaded photos. Idempotent. | one-shot | delete once the bucket exists in all environments |
